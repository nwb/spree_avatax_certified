Spree::Order.class_eval do
  ...
  def avalara_capture_finalize
    ...
    create_avalara_transaction if avalara_transaction.nil?
    return true unless avalara_transaction.order.ship_address.country.id==214 && avalara_transaction.order.ship_address.state && (%w(GA CA).include? avalara_transaction.order.ship_address.state.abbr)
